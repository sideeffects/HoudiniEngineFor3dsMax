...
class HEMAX_AssetWidget : public QWidget
{
    Q_OBJECT

    public:
	HEMAX_AssetWidget(HEMAX_Plugin* ActivePlugin);
	HEMAX_AssetWidget(HEMAX_Plugin* ActivePlugin, std::string AssetsBoxTitle);
	~HEMAX_AssetWidget() = default;
