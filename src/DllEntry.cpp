...
extern ClassDesc2* GetHEMAXLauncherDesc();
extern ClassDesc2* GetHEMAX_ModifierClassDesc();
extern ClassDesc2* GetHEMAX_IntegerParameterAttrib_ClassDesc();
extern ClassDesc2* GetHEMAX_StringParameterAttrib_ClassDesc();
