...
#define HEMAX_SESSION_SHARED_MEMORY_NAME_DEFAULT    "shared_memory_3dsmax"
#define HEMAX_SESSION_SHARED_MEMORY_BUFFER_SIZE_DEFAULT "100"
#define HEMAX_SESSION_SHARED_MEMORY_BUFFER_TYPE_DEFAULT "Fixed"
...
HEMAX_UserPrefs::HEMAX_UserPrefs()
{
    ...
    AddUserSetting(HEMAX_SETTING_SESSION_CONNECTION_TIMEOUT,
        HEMAX_SETTING_TYPE_INT, HEMAX_SESSION_CONNECTION_TIMEOUT_DEFAULT);
    ...
    AddUserSetting(HEMAX_SETTING_SESSION_SHARED_MEMORY_NAME,
                   HEMAX_SETTING_TYPE_STRING,
                   HEMAX_SESSION_SHARED_MEMORY_NAME_DEFAULT);
    AddUserSetting(HEMAX_SETTING_SESSION_SHARED_MEMORY_BUFFER_SIZE,
                   HEMAX_SETTING_TYPE_INT,
                   HEMAX_SESSION_SHARED_MEMORY_BUFFER_SIZE_DEFAULT);
    AddUserSetting(HEMAX_SETTING_SESSION_SHARED_MEMORY_BUFFER_TYPE,
                   HEMAX_SETTING_TYPE_STRING,
                   HEMAX_SESSION_SHARED_MEMORY_BUFFER_TYPE_DEFAULT);
